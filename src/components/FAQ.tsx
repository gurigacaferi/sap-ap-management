...
const faqs = [
  ...
  },
  {
    ...
    answer: "By utilizing our specialized hub for your AP processing, you can typically save between 50% and 60% compared to local in-house hiring in Western markets. Contact us for a customized rate based on your specific volume and requirements."
  }
];
