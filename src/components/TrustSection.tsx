      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {trustFactors.map((factor, index) => (
            <div key={index} className="bg-[#F8F9FA] p-8 rounded-xl border border-gray-100 flex flex-col h-full">
              <div className="w-14 h-14 bg-white rounded-lg flex items-center justify-center mb-6 shadow-sm">
                <factor.icon className="w-7 h-7 text-[#0B1B35]" />
              </div>
        ...
        {/* Statistics Block */}
        <div className="mt-20 grid md:grid-cols-2 gap-8 items-center bg-[#0B1B35] rounded-3xl p-8 lg:p-16 text-white overflow-hidden relative">
